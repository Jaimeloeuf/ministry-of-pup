...
onMounted(function () {
  ...
  currentTestimonial.value = Math.floor(Math.random() * testimonials.length);
...
//     else currentTestimonial.value = 0;
...
function prev() {
  if (currentTestimonial.value > 0) currentTestimonial.value -= 1;
  else currentTestimonial.value = testimonials.length - 1;
}
